/* FUN_00403250 @ 0x00403250 size=452 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void __fastcall FUN_00403250(int param_1,short param_2,short param_3)

{
  ...
  if (param_1 == DAT_0040c72c) {
    ...
    if (DAT_0040c958 == 0) {
      ...
      if (0x4100 < sVar2) {
        iVar3 = FUN_00402e30(DAT_0040c698,DAT_0040c708,(int)sVar2,(int)param_3,0x4100);
        DAT_0040c958 = 0;
        DAT_0040c944 = iVar3 - DAT_0040c948;
        _DAT_0040c960 = 1;
        FUN_00402e80();
        FUN_00402ec0(&DAT_0040c0f8,DAT_0040c944,1);
        return;
      }
      if (sVar2 < 0x281) {
        DAT_0040c958 = 0;
